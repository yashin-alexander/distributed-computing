 ...
 */
static const char * const log_started_fmt = "%d: process %1d (pid %5d, parent %5d) has STARTED with balance $%2d\n";
 ...
 */
static const char * const log_loop_operation_fmt = "process %1d is doing %d iteration out of %d\n";
